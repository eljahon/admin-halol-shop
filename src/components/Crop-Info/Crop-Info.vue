...
//     { label: 'diseases-plants', id: 1, key: 'plants', icon: 'pi pi-info-circle' },
//     { label: 'news', id: 3, key: 'news', icon: 'pi pi-info-circle' },
//     { label: 'fertilizers', id: 2, key: 'fertilizers', icon: 'pi pi-info-circle' }
// ]);
