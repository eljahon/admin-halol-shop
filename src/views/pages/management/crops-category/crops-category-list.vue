...
const { getCropsCategory, deleteCropsCategory } = actions(['cropsCategory'], { get: true, remove: true });
function openNew() {
    router.push({ name: 'cropsCategory-create', params: { id: 'new' } });
}
    ...
    <div>
        ...
        <div class="card">
            ...
            <DataTable ref="dt" :value="crops" dataKey="id" :loading="isLoading">
                ...
                <Column field="code" :header="$t('code')" style="min-width: 12rem"></Column>
