...
const { getUsefullinfos, deleteUsefullinfos } = actions(['usefullinfos'], { get: true, remove: true });
...
function deleteProduct() {
    ...
    deleteUsefullinfos(crop.value.id)
        .then((res) => {
            crop.value = {};
