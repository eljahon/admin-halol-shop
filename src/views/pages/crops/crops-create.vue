...
const is_common = ref();
let updateValue = ref();
let textFild = ref('<div>Hello World!</div><div>PrimeVue <b>Editor</b> Rocks</div><div><br></div>');
...
<!--                    <Editor v-model="textFild"/>-->
                </template>
            </FormBuilder>
            <CustomEditor :modelValue="textFild"/>
        </div>
    </div>
</template>
