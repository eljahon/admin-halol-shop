...
function upateModelValue (valuve) {

}
const { postNews, putNews, getNews, getByIdNews } = actions(['news'], { get: true, post: true, put: true, getById: true });
        ...
        <div class="card">
            <FormBuilder v-bind="{ isSubmit, isUpdate, updateValue, feilds }" @handel-submit-form="handleSubmitFrom" :methods="[,,,,,,,, updateEditor]">
                <template #default="{ values, set }">
                    <div><SelectsIndex action-name="" filter-name=""/></div>
                    <div class="flex justify-between">
                        <div class=" w-1/2 flex justify-around gap-10">
                            ...
                            <div class="w-full"><VideoUpload folder="news" :modelValue="videoList" @update:modelValue="onImageUploadVideo"/></div>
                        </div>
